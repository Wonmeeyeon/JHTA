...
<div class="container">
	...
	<div class="row">
		<div class="col-md-3">컨텐츠</div>
			
		<div class="col-md-9">메뉴</div>
	</div>
	<div class="row">
		<div class="col-md-12">푸터</div>
	</div>
...
<!-- 
	부트스트랩의 그리드 시스템
	* 모든 행 (<div class="row">)는 적절한 정렬과 패딩을 위해서 반드시 <div class="container>안에 위치해야한다.
	* 하나의 행은 하나 이상의 열(<div class="col-*-n">)로 수평그룹을 만들 수 있다.
	* 모든 컨텐츠(제목, 내용, 테이블, 버튼, 리스트, 폼 ... )는 열(<div class="col-*-n">)안에 위치해야한다.
