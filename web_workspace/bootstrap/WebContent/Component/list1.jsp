		...
		<div class="row">
			...
			<div class="col-4">
				...
				<div class="list-group">
					<a class="list-group-item list-group-item-action" href="hr.jsp">인사부</a>
					<a class="list-group-item disabled" href="money.jsp">총무부</a>
					<a class="list-group-item" href="mar.jsp">관리부</a>
		...
		<div class="col-4"> 
			...
			<ul class="list-group">
				<li class="list-group-item d-flex justify-content-between align-items-center">
					미처리 건수 <span class="badge badge-danger badge-fill">10</span>
				</li>
				<li class="list-group-item d-flex justify-content-between align-items-center">
					처리중 건수 <span class="badge badge-info badge-fill">10</span>
				</li>
				<li class="list-group-item d-flex justify-content-between align-items-center">
					처리완료 건수 <span class="badge badge-success badge-fill">10</span>
				</li>
			</ul>
		</div>
		<div class="col-8"> 
			...
			<div class="list-group">
				<a href="#" class="list-group-item list-group-item-active">
					...
					<p class="mb-1">프로젝트 일정이 변경되었습니다. 6월 12일 금요일 부터 2주간 실시하겠습니다. 각 조별로 일정 조정하시고,
					내용은 메일로 작성해주시기 바랍니다.</p>
					<small>홍길동</small>
				</a>
				<a href="#" class="list-group-item list-group-item-active">
					<div class="d-flex w-100 justify-content-between">
