...
<div class="container">
	...
	// 		<html 컨텐츠>가 시작값-종료값 번위만큼 반복해서 표시된다.
      ...
      <div class="col-12 text-center">
         <ul class="pagination">
            ...
            <c:forEach var="num" begin="${beginPage }" end="${endPage }">            
               <li class="page-item ${param.pageno eq num ? 'active' : '' }"><a class="page-link ${param.pageno eq num ? 'active' : '' }" href="foreach.jsp?pageno=${num }">${num }</a></li>
            </c:forEach>
