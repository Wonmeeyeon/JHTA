...
public class TodoDao {
	...
	public int getTodoSequence() throws SQLException {
		return JdbcHelper.selectOne(QueryUtil.getSQL("todo.getTodoSequence"), new RowMapper<Integer>() {
	...
	public void insertTodo(Todo todo) throws SQLException {
		JdbcHelper.insert(QueryUtil.getSQL("todo.insertTodo"), todo.getNo(), todo.getTitle(), todo.getContent(), todo.getDay(), todo.getStatus(), todo.getUserId());
	}
	...
	public List<Todo> getTodosByUserId(String userId) throws SQLException {
		return JdbcHelper.selectList(QueryUtil.getSQL("todo.getTodosByUserId"), new RowMapper<Todo>() {
	...
	public void updateTodo(Todo todo) throws SQLException {
		JdbcHelper.update(QueryUtil.getSQL("todo.updateTodo"), todo.getTitle(), todo.getContent(), todo.getDay(), todo.getCompletedDay(), todo.getStatus(), todo.getNo() );
	}
}
