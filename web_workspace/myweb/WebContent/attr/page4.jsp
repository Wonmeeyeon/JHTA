...
<%
	...
	System.out.println("page1.jsp의 HttpServletRequest에서 조회한 값: " + RequestValue);
	System.out.println("page1.jsp의 HttpSession에서 조회한 값: " + sessionValue);
	System.out.println("page1.jsp의 ServletContext에서 조회한 값: " + applicationValue);
	
	// page5.jsp로 내부이동시킨다.
	// RequestDispatcher는 클라이언트의 요청을 다른 JSP로 이동시키는 기능을
	// 가진 객체다.
