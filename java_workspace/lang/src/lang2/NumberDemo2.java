...
public class NumberDemo2 {
	public static void main(String[] args) {
		...
		// 정수가 long의 범위를 벗어날 때는 BigInteger을 사용한다.
		...
		System.out.println("뺄셀겸과: " + result2.toString());
		
		BigInteger result3 = big1.multiply(big2);
		System.out.println("뺄셀겸과: " + result3.toString());
		
		BigInteger result4 = big1.divide(big2);
		System.out.println("뺄셀겸과: " + result4.toString());
	}
