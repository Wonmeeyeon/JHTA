...
public class StringDemo1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("원본문자열: " + str3);
		System.out.println("대문자로 구성된 문자열: " + s3);
		System.out.println("소문자로 구성된 문자열: " + s4);
		
		// String replace(CharSequence old, CharSequence nw) : 문자열에서 지정된(old) 문자열을 새문자열(nw)로 변환한 새로운 문자열을 반환한다.
		// String replaceAll(String regexp, String replacement) : 문자열에서 지정된 정규표현식과 일치하는 문자열을 찾아서 새문자열로 변환한 새로운 문자열을 반환한다.
		...
		// int intdexOf(String str) : 문자열에 지정된 문자열이 있으면 그 위치를 반환한다. 없으면 -1을 반환한다.
		// int lastIndexOf(String str) : 문자열에 지정된 문자열이 마지막으로 등장하는 위치를 반환한다.없으면 -1을 반환한다.
		...
		// boolean startWith(String prefix) : 문자열이 지정된 문자열로 시작하면 true를 반환한다.
		...
		// String trim() : 문자열에서 불필요한 좌우공백을 제거한 새로운 문자열을 반환한다. 문자 사이의 공백은 없어지지 않음
