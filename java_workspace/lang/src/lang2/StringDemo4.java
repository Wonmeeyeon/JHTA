...
public class StringDemo4 {
	...
	public static void main(String[] args) {
		...
		// 주요 메소드
		//		StringBuilder append(다양한 타입 값) : 맨 뒤에 붙인다.
		//		StringBuilder delete(int begin, int end) : 지정된 범위의 문자열을 삭제한다.
		//		StringBuilder insert(int position, 다양한 타입 값) : 지정된 위치에 문자열을 삽입한다.
		//		StringBuilder replace(int start, int end, String srt) : 지정된 범위의 문자열을 새 문자열로 변경한다.
		...
		// StringBuffer와 StringBuilder은 메소드체이닝을 지원한다.
