...
(
	...
	CONSTRAINT SYS_C007020 PRIMARY KEY (ANSWER_NO)
);
...
(
	...
	CONSTRAINT SYS_C007017 PRIMARY KEY (QUESTION_NO)
);
...
(
	...
	BOOK_NO number(6),
	USER_ID varchar2(50 char),
	CONSTRAINT REVIEWNO_PK PRIMARY KEY (REVIEW_NO)
);
...
(
	...
	USER_EMAIL varchar2(256 char) NOT NULL,
...
ALTER TABLE HR.SAMPLE_BOOK_ANSWERS
	ADD CONSTRAINT SYS_C007021 FOREIGN KEY (QUESTION_NO)
...
ALTER TABLE HR.SAMPLE_BOOK_QUESTIONS
	ADD CONSTRAINT SYS_C007018 FOREIGN KEY (USER_ID)
	REFERENCES HR.SAMPLE_BOOK_USERS (USER_ID)
;
