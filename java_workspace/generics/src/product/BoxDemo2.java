...
//		box1.add(new SmartPhone("아이폰", 1600000, "010-1111-1111","192.192.156.222"));
		
		//SmartPhone가 타입파라미터로 지정된 Box객체
		//SmartPhone객체만 다룰 수 있다.
		Box<SmartPhone> box2 = new Box<SmartPhone>();
//		box2.add(new Tv("초대형 텔레비전", 5000000, 100.5));
		box2.add(new SmartPhone("아이폰", 1600000, "010-1111-1111","192.192.156.222"));
		...
		box3.add(new SmartPhone("아이폰", 1600000, "010-1111-1111","192.192.156.222"));
	}
